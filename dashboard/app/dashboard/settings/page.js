    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'odds' ? 'bg-blue-600/20 border-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'bounds' ? 'bg-emerald-600/20 border-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">🛑</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'strings' ? 'bg-purple-600/20 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">💬</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'system' ? 'bg-rose-600/20 border-rose-500 shadow-[0_0_20px_rgba(244,63,94,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">⚡</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'payment' ? 'bg-indigo-600/20 border-indigo-500 shadow-[0_0_20px_rgba(99,102,241,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">💳</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'withdraw' ? 'bg-cyan-600/20 border-cyan-500 shadow-[0_0_20px_rgba(6,182,212,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">🏦</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'security' ? 'bg-amber-600/20 border-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">🔒</span>
        ...
        <button
          ...
          className={`p-6 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-xl hover:-translate-y-1 hover:shadow-2xl ${activeSection === 'maintenance' ? 'bg-orange-600/20 border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.3)]' : 'bg-slate-800 border-slate-700 hover:border-slate-600'
            }`}
        >
          <span className="text-4xl">🧹</span>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      readOnly
                      value={typeof window !== 'undefined' ? `${window.location.origin.replace('3000', '1')}/api/deposit/callback` : ''}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8 flex flex-col h-full">
              ...
              <button
                ...
                className={`w-full py-5 font-black text-white rounded-xl shadow-lg transition-all disabled:opacity-50 mt-auto ${saving ? 'bg-slate-700' : 'bg-gradient-to-r from-emerald-600 to-teal-500 hover:shadow-emerald-500/30'
                  }`}
              >
